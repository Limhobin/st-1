...
st.set_page_config(page_title="축제를 바꾸자 - 전라남도 축제 개혁 제안", layout="wide")
...
if menu == "메인":
    st.session_state.page = "home"
    st.title("🎉 전라남도 축제, 이대로 괜찮을까요?")
    st.image("https://i.namu.wiki/i/BkBQE9nspVsdIziAAE1CbGg8gaXjCqieyXAgmMtEzaCXvrfZVV3p_TX1YUDqlhgBDFL6FGAGTE8ZnhIDUSiFPQ.webp", width=700)
    st.markdown("""
